...
```text
.
├── docs/                  # Supports, diagrammes et documentation
├── chapters/              # Ressources organisées par chapitre
├── workshops/             # Ateliers pratiques
├── prosits/               # Situations-problèmes
├── jobboard/              # Projet fil rouge
├── PROMPTS.md             # Traçabilité IA lorsque demandée
├── README.md              # Présentation générale du module
└── LICENSE
```

L’organisation réelle peut évoluer, mais chaque branche ou dossier doit fournir un README clair indiquant :
...
Selon les chapitres, les livrables peuvent inclure :

- code source ;
- diagrammes d’architecture ;
- contrats REST ;
- documentation Swagger/OpenAPI ;
- collection de tests ou tests automatisés ;
- fichiers Docker ;
- documentation d’installation ;
- démonstration ;
- rapport synthétique ;
- fichier `PROMPTS.md` lorsque l’usage de l’IA doit être tracé.
